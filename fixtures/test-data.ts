...
export const INVALID_USERNAME = "INVALID_EMAIL";
export const NONEXISTANT_USERNAME = "testuser@test.com";
export const INVALID_PASSWORD = "BAD_PASSWORD";
export const SAMPLE_NAME = "Test";
export const GOOGLE_SIGNIN_URL_REGEX = "^https://accounts.google.com";
export const FACEBOOK_SIGNIN_URL_REGEX = "^https://www.facebook.com";
